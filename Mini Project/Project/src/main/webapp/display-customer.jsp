...
<%	if (session.getAttribute("uname") != null && session.getAttribute("uname") != "") {	%>
	...
	<div class="content-wrapper">
		<div class="container-fluid">
			...
			%>
			<div class="alert alert-info" id="info">Customer updated successfully.</div>
			<% } %>
			<%
			...
			%>
			<div class="alert alert-danger" id="danger">Customer deleted successfully.</div>
			<%	}	%>
			<div class="row">
				<div class="col-md-12">
					<!-- Advanced Tables -->
								...
								<table class="table table-striped table-bordered table-hover"
									...
									<tbody>
										...
										<tr class="odd gradeX">
											...
											<td><%=resultset.getString("c_contact")%></td>
											<td class="center"><%=resultset.getString("c_email")%></td>
											<td class="center" style="width:150px;"><%=resultset.getString("c_address")%></td>
											<td class="center"><%=resultset.getString("created_at")%></td>
											<td class="center"><%=resultset.getString("updated_at")%></td>
											<td><a href="update-customer-info.jsp?cid=<%=resultset.getString("c_id")%>" class="btn btn-info">Update</a>|<a
												href="DeleteCustomer?cid=<%=resultset.getString("c_id")%>" class="btn btn-danger">Delete</a></td>
										</tr>
										<%	}	%>
									</tbody>
								</table>
