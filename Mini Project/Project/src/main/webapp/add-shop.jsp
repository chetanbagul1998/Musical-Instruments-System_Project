	...
	<div class="content-wrapper">
		<div class="container">
			<div class="row pad-botm">
				<div class="col-md-12">
					<h4 class="header-line">Add Shop</h4>
				</div>
			</div>
			<%	String success = (String) session.getAttribute("shop-add");
				if (success != null) {
				session.removeAttribute("shop-add");
			%>
			<div class="alert alert-info" id="info">Shop added	successfully.</div>
			<% }%>
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							<form role="form" action="AddShops" method="post">
								<div class="form-group">
									<label>Shop Name</label> <input class="form-control" type="text" name="sname" />
								</div>
								<div class="form-group">
